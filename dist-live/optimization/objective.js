...
export async function evaluateParams(params, symbol, baseCfg, klineCache) {
    ...
    const klinesBySymbol = { [symbol]: klines };
 ...
 */
export function applyParams(params, baseCfg) {
    return {
        ...baseCfg,
        strategy: {
            ...baseCfg.strategy,
