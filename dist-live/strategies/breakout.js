...
const breakoutStrategy = {
    id: "breakout",
    name: "Trend Breakout",
    description: "Close breaks above highest of past N klines + volume surge -> buy; breaks below lowest -> sell. Suitable for trending markets.",
    populateSignal(ctx) {
        ...
        for (const k of window) {
            if (k.close > windowHigh)
                windowHigh = k.close;
            if (k.close < windowLow)
                windowLow = k.close;
