 ...
 */
export function ensembleVote(config, ctx) {
    ...
    for (const entry of config.strategies) {
        ...
        switch (signal) {
            ...
            case "sell":
                ...
                break;
            case "short":
                shortScore += normalizedWeight;
                break;
            case "cover":
                coverScore += normalizedWeight;
                break;
...
function scoreForSignal(signal, buyScore, sellScore, shortScore, coverScore) {
    switch (signal) {
