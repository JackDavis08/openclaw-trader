...
const rsiReversalStrategy = {
    id: "rsi-reversal",
    name: "RSI Mean Reversion",
    description: "RSI < oversold -> buy (oversold bottom fishing); RSI > overbought -> sell (overbought exit). Suitable for ranging/sideways markets." +
