 ...
 */
export function shouldConfirmExit(position, exitReason, maxDeviation, strategy, ctx) {
 ...
 */
export function isExitRejectionCoolingDown(symbol, cooldownMs, rejectionLog) {
