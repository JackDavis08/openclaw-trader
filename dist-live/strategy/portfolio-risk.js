 ...
 */
export function calcCorrelationAdjustedSize(newSymbol, newSide, baseRatio, existingPositions, klinesBySymbol, lookback = 60, maxHeat = 0.85) {
 ...
 */
export function calcPortfolioExposure(positions, totalEquity, klinesBySymbol) {
    ...
    let avgPairwiseCorrelation = null;
...
// Formatting
// ─────────────────────────────────────────────────────
export function formatPortfolioExposure(summary) {
    const lines = [
        `📊 **Portfolio Exposure**`,
