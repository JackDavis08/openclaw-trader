 ...
 */
export function getMinimalRoiThreshold(roiTable, holdMs) {
    ...
    if (applicableKeys.length === 0)
        return null; // Not yet in the first tier
 ...
 */
export function checkMinimalRoi(roiTable, holdMs, profitRatio) {
 ...
 */
export function formatRoiTable(roiTable) {
 ...
 */
export function calcLongProfitRatio(entryPrice, currentPrice) {
    if (entryPrice <= 0)
        return 0;
 ...
 */
export function calcShortProfitRatio(entryPrice, currentPrice) {
    if (entryPrice <= 0)
        return 0;
